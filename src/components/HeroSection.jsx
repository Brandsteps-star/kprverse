        ...
        <section className="hero-section relative h-screen z-20 pt-24 px-8 pl-28  max-md:px-2 max-md:pt-16 w-full text-white">
            <div className="flex flex-col justify-between gap-8 relative z-30">
                ...
                <div className="place-self-end relative gap-0 w-full h-[80vh] flex items-end justify-end">
                    ...
                    <div className="flex items-start absolute top-[9.5vw] right-0 max-md:top-[85%]">
                        <span className="font-mono extra-sm-text mt-4 max-md:mt-0">02K</span>
                        <h1 className="text-[12vw] leading-[12vw] font-black font-whyte-inktrap tracking-[-13px] max-md:tracking-normal max-md:text-[13vw]">PROTECT.</h1>
                    </div>
                    <div className="flex items-start absolute top-[19vw] left-0 max-md:top-[92%]">
                        <span className="font-mono extra-sm-text mt-4 max-md:mt-0">03K</span>
                        <h1 className="text-[12vw] leading-[12vw] font-black font-whyte-inktrap tracking-[-13px] max-md:tracking-normal max-md:text-[13vw]">REIMAGINE.</h1>
                    </div>
                </div>
            </div>
        </section>
