        ...
        <div className="relative z-50 section5 w-[98vw] min-h-screen max-sm:w-full max-md:pl-0 pl-[68px] pt-[70px] overflow-x-hidden font-whyte-inktrap flex flex-col gap-18">
            <div className="flex items-center w-full">
                ...
                <div className="h-[25vh] max-sm:h-[10vh] flex items-center justify-start p-4 max-md:p-2 text-white border-b  border-[#ffffff2a]">
                    ...
                    <h3 className="section-title uppercase text-[44px] leading-[44px] max-md:text-[30px] max-sm:text-[28px] max-sm:leading-[34px] max-sm:tracking-0 font-black pl-20 tracking-[-2px]">
                        10,000 unique digital
                    </h3>
                    <h3 className="section-title uppercase text-[44px] leading-[44px] max-md:text-[30px]  max-sm:text-[28px] max-sm:leading-[34px] max-sm:tracking-0 font-black mt-[-5px] tracking-[-2px]">
                        collectibles.
                    </h3>
                    </div>
                </div>
