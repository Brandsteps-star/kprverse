export const HeroSection = () => {
    return(
        <section id="project" className="hero-section relative h-screen z-20 pt-24 px-8 pl-28  max-md:px-2 max-md:pt-16 w-full text-white">
            <div className="flex flex-col justify-between gap-8 pb-8 max-sm:pb-16 max-sm:pr-0 pr-8 relative z-30 h-full mb-12">
                ...
                <div className="relative gap-0 w-full flex flex-col items-end max-sm:items-start justify-end mt-auto">
                    <div className="flex items-start">
                        ...
                        <h1 className="hero-heading max-md:!tracking-normal max-md:!text-[13vw] font-hexaframe">KEEP.</h1>
                    </div>
