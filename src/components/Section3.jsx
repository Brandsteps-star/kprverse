        ...
        <div className="relative h-[60vh] flex max-sm:items-end max-sm:h-[30vh] max-md:w-full w-full text-white  border-y border-[#FFFFFF33]">
          <div className="px-6 py-8 w-[70%] max-sm:w-full max-md:p-2 border-r border-[#FFFFFF33] max-sm:border-none">
            <div className="relative">
              ...
              <h3 className="section-title text-[44px] leading-[44px] max-md:text-[30px] max-sm:text-[20px] max-sm:leading-[26px] max-sm:tracking-0 font-black pl-20 max-sm:pl-12 tracking-[-2px] max-sm:tracking-[0] uppercase">
                You are a Keeper: an agent
              </h3>
              <h3 className="section-title text-[44px] leading-[44px] max-md:text-[30px] max-sm:text-[20px] max-sm:leading-[26px] max-sm:tracking-0 font-black mt-[-5px] tracking-[-2px] max-sm:tracking-[0] uppercase">
